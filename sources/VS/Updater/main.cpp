...
/*
    ***јлгоритм обновлени€ ***
    ...
    ѕосле запуска программа начинате опрашивать заданный com - порт на скорости 115200 запросом "a101?" с завершающим нулЄм.
    ...
    1. update101.exe посылает 4 байта размера прошивки(без завершающего нул€) и переходит в режим прослушивани€
